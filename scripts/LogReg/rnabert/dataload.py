...
for sample in ['20','60','140','240','362']:
    ...
    for rna in tqdm(rnas):
        ...
        #structure = np.load('./1mer_cmaps_nodiag/'+rnaid+'_contacts.npz')['b'] # Change source directory
    ...
    np.savez_compressed(f'../data/diagtest/rnabert/training_{sample}.npz', x=X_train, y=y_train)
