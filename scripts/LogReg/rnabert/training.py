...
for mode in tqdm(["logreg", "mlp", "tr", "rf", "xgb"]):
    for N in ["20", "60", "140", "240", "362"]:

        print(f'Computing [{lm} / {mode} / {N}] ..')
        print('Loading training dataset..')
        #data = np.load(f'../../../../data/training/{lm}/training_{N}.npz')
        data = np.load(f'../data/diagtest/rnabert/training_{N}.npz')
        ...
        if mode == 'logreg':
            ...
            dump(logreg, f'./diagmodels/{lm}_logreg_{N}.joblib')
            ...
            dump(mlp, f'./diagmodels/{lm}_mlp_{N}.joblib')
            ...
            dump(tr, f'./diagmodels/{lm}_tr_{N}.joblib')
            ...
            dump(rf, f'./diagmodels/{lm}_rf_{N}.joblib')
            ...
            dump(xgb, f'./diagmodels/{lm}_xgb_{N}.joblib')
            ...
            dump(lda, f'./models/{lm}_lda_{N}.joblib')
            ...
            dump(knn, f'./models/{lm}_knn_{N}.joblib')
            ...
            dump(gnb, f'./models/{lm}_gnb_{N}.joblib')
