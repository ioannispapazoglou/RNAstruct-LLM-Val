...
def process_file(file_path):
    ...
    cmap = generate_pad_cmap_hv(file_path, cut_off = 9.5)
    contact_map = np.array(cmap)
    #-----------------------------------------------------------------------------------------
    np.savez_compressed('./indipedents/contacts95_rhofold/'+pdb_name+'_contacts.npz', b=contact_map)  # Change save location
    #-----------------------------------------------------------------------------------------

if __name__ == '__main__':
    #-----------------------------------------------------------------------------------------
    directory = '../benchmark/rhofold/' # Change input folder
    #-----------------------------------------------------------------------------------------
